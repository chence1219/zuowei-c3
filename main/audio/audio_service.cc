...
void AudioService::Start() {
    ...
    xTaskCreatePinnedToCore([](void* arg) {
        ...
        vTaskDelete(NULL);
    }, "audio_input", CONFIG_AUDIO_INPUT_TASK_STACK_SIZE, this, 8, &audio_input_task_handle_, 1);
#else
    xTaskCreate([](void* arg) {
        AudioService* audio_service = (AudioService*)arg;
        audio_service->AudioInputTask();
        vTaskDelete(NULL);
    }, "audio_input", CONFIG_AUDIO_INPUT_TASK_STACK_SIZE, this, 8, &audio_input_task_handle_);
#endif
    ...
    xTaskCreate([](void* arg) {
        ...
        vTaskDelete(NULL);
    }, "audio_output", CONFIG_AUDIO_OUTPUT_TASK_STACK_SIZE, this, 3, &audio_output_task_handle_);
    ...
    xTaskCreate([](void* arg) {
        ...
        vTaskDelete(NULL);
    }, "opus_codec", CONFIG_OPUS_CODEC_TASK_STACK_SIZE, this, 2, &opus_codec_task_handle_);
}
...
void AudioService::PlaySound(const std::string_view& sound, bool reset_decoder) {

    if (opus_decoder_ == NULL) {
        ESP_LOGW(TAG, "Opus decoder is release");
        return;
    }
